  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Consumer<ChannelListProvider>(
      ...
      body: Consumer<ChannelListProvider>(
        builder: (context, provider, child) {
        ...
        actions: [
          TextButton(
            onPressed: selectedUsers.isEmpty ? null : () async {
              ...
              await context.read<ChannelListProvider>().addMembersToChannel(
                channelId: widget.channelId,
                userIds: userIds,
              );
            ...
            child: Consumer<ChannelListProvider>(
              builder: (context, provider, child) {
                ...
                final filteredUsers = users.where((user) => 
                  ...
                  !context.read<ChannelListProvider>().channelMembersList
